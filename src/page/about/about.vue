<template>
    <div class=" posit">
        ...
        <div class="posit">
            <div :class="{'addTopHeight': !($alipayBool)}">
                <div class="about scoll">
                    <div  v-for="(item, index) in questions">
                        ...
                        <div class="about-item aboutDate-date" v-if="item.type==='NUMBER'">
                            ...
                            <div v-if="item.subLabel" class="date-text" style="padding: 4px 0 0;">{{item.subLabel}}</div>
        ...
        <div class="btn-box" style="border-top: 1px solid #cdcdcd;">
