<template>
    <div class="aboutDate posit-box">
        <question-head-web v-if="!$alipayBool"  @backClick="changeBack" v-bind:data="{title:$t('message.head.about'),level:level}"></question-head-web>
...
<script>
    ...
    import {ajax,getQuestionsAll,dateFormat,setSession,getSession,getQuestions,PackageId, setQuestions, clearQuestionItem , clearQuestionNumber , getQuestionsItem} from "@/util/util";
