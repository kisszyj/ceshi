<template>
    <div class="posit" :class="{'addTopHeight': !($alipayBool)}">
        <head-top v-if="!$alipayBool"  @backClick="changeBack" v-bind:data="{title:$t('message.head.aboutDetail'),start:true}"></head-top>
        <div class="posit">
            <div class="aboutDetail scoll" v-bind:style="mask?'overflow: hidden;':''">
                <div class="aboutDetail-top">
                    <div class="aboutDetail-title">{{ page_titel }}</div>
                ...
                <div class="aboutDetail-tiaokuan">
                ...
                <div class="aboutDetail-push" :class="iconstart?'start':''" @click="iconStartFun">
